...
public abstract class BasePdfCreator implements PdfCreator {
    ...
    @Override public @NotNull String create(final @NotNull PdfData input) {
    ...
    protected abstract @NotNull Context getContext(final @NotNull PdfContextData contextData);
}
